...
$bottom_link_title = wpex_get_mod('mobile_nav_bottom_menu_title');
$bottom_link_url = wpex_get_mod('mobile_nav_bottom_menu_url');
$bottom_link_nt = wpex_get_mod('mobile_nav_bottom_menu_nt');
?>
...
<div id="mobile-menu-search" class="clr wpex-hidden">
	...
	<?php if($bottom_link_title && $bottom_link_url): ?>
    <div class="mobile-menu-bottom-link">
        <a href="<?php echo esc_url($bottom_link_url); ?>" <?php if($bottom_link_nt){echo ' target="_blank"';} ?>><?php echo esc_html($bottom_link_title); ?></a>
    </div>
	<?php endif; ?>
</div>