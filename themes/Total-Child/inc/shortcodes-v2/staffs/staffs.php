...
class EASL_VC_Staffs extends EASL_ShortCode {
...
if ( is_admin() ) {
    ...
    // Get autocomplete suggestion
    add_filter( 'vc_autocomplete_easl_staffs_top_staffs_callback', 'vcex_suggest_staff_members', 10, 1 );
    // Render autocomplete suggestions
    add_filter( 'vc_autocomplete_easl_staffs_top_staffs_render', 'vcex_render_staff_members', 10, 1 );
}