            ...
            <div class="easl-scientific-publication-inner">
                ...
                if ( $easl_query->have_posts() ) {
                    while ( $easl_query->have_posts() ):
                        ...
                        ?>
                        <article class="scientific-publication <?php if ( ! $image_src ) {
                            ...
                            <div class="scientific-publication-content  sp-content">
                                <div class="sp-item-meta-title">
                                    ...
                                    <h3>
                                        <a href="<?php echo $read_more_link; ?>" <?php echo $target; ?> class="<?php if ( $needs_modal ): ?>sp-modal-trigger<?php endif; ?>"><?php the_title(); ?></a>
                                    </h3>
                                </div>
                                <p class="sp-excerpt"><?php echo $excerpt; ?></p>
                                <a class="easl-button<?php if ( $needs_modal ): ?> sp-modal-trigger<?php endif; ?>" href="<?php echo $read_more_link; ?>" <?php echo $target; ?>><?php _e( 'Read More', 'total-child' ); ?>
...
<?php require_once( get_stylesheet_directory() . '/partials/publication/publication-modal.php' );