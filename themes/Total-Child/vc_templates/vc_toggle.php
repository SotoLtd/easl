 ...
 */
$title = $el_class = $style = $color = $size = $open = $has_padding = $css_animation = $css = $el_id = '';
...
if($use_custom_heading) {
    $class_to_filter .= ' vc_toggle_has_padding';
}
