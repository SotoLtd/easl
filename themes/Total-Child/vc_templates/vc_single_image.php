...
$image_over_link_html = '';
if ( '' !== $img_over_link_text ) {
	$img_over_link_text = str_replace(array('html_span_open', 'html_span_close', 'html_br'), array('<span>', '</span>', '<br/>'), $img_over_link_text);
	if('' != $img_over_link ){
		$image_over_link_html .= '<a class="easl-vc-image-over" href="'. esc_url($img_over_link) .'" target="'. $img_over_linktarget .'">' .  $img_over_link_text . '</a>';
	}else{
		$image_over_link_html .= '<span class="easl-vc-image-over">' . $img_over_link_text . '</span>';
	}
	
}
$html .= $image_over_link_html;
