 ...
 * @var $el_id
 * @var $css
 * @todo Refactor and re organize codes
...
<div class=" <?php echo esc_attr( $css_class ); ?>" <?php echo implode( ' ', $wrapper_attributes ); ?>>
	<?php if ( $annual_reports->have_posts() ): ?>
        <div class="annual-reports-top-row">
			<?php
			while ( $annual_reports->have_posts() ):
				the_row();
				$image                   = wp_get_attachment_image_url( get_post_thumbnail_id(), 'single-post-thumbnail' );
				$annual_reports_pdf_file = get_field( 'annual_reports_pdf_file' );
				?>
                <div class="annual-report">
                    ...
                    <div class="annual-report-details">
                        <h2><?php the_title(); ?></h2>
						<?php if ( $annual_reports_pdf_file ): ?>
                            <p>
                                <a href="<?php echo $annual_reports_pdf_file; ?>">View and download report <span class="ticon ticon-angle-right"></span></a>
                            </p>
						<?php endif; ?>
                    </div>
                </div>
