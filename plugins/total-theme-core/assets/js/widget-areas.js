( function( $ ) {
	...
	"use strict";
		...
		var WPEX_Widget_Areas = function() {
			...
			this.nonce = wpexWidgetAreasLocalize.nonce;
			this.add_form_html();
			this.add_del_button();
			this.bind_events();
		};
			...
			add_del_button: function() {
				...
				this.widget_area.find('.sidebar-wpex-custom .widgets-sortables').each(function() {
					if ( i >= wpexWidgetAreasLocalize.count ) {
						...
						$(this).append('<div class="wpex-widget-area-footer"><div class="wpex-widget-area-id">ID: <input value="' + widgetID + '" type="text" readonly onclick="this.select()" /></div><div class="wpex-widget-area-buttons"><a href="#" class="wpex-widget-area-delete button-primary">'+ wpexWidgetAreasLocalize.delete +'</a><a href="#" class="wpex-widget-area-delete-cancel button-secondary">'+ wpexWidgetAreasLocalize.cancel +'</a><a href="#" class="wpex-widget-area-delete-confirm button-primary">'+ wpexWidgetAreasLocalize.confirm +'</a></div></div>')
					}
					i++;
				} );
			},
