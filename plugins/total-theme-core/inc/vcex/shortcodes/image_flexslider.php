	...
	class VCEX_Image_Flexslider_Shortcode {
		...
		public function __construct() {
			...
			if ( function_exists( 'vc_lean_map' ) ) {
				TotalThemeCore\WPBakery\Map\Vcex_Image_Flexslider::instance();
			}
		...
		public function output( $atts, $content = null ) {
			ob_start();
			do_action( 'vcex_shortcode_before', 'vcex_image_flexslider', $atts );
			include( vcex_get_shortcode_template( 'vcex_image_flexslider' ) );
			do_action( 'vcex_shortcode_after', 'vcex_image_flexslider', $atts );
			return ob_get_clean();
		}
		...
		public static function get_params() {
			...
			return apply_filters( 'vcex_shortcode_params', $params, 'vcex_image_flexslider' );
