...
if ( ! class_exists( 'VCEX_Post_Type_Carousel_Shortcode' ) ) {
	...
	class VCEX_Post_Type_Carousel_Shortcode {
		...
		public function __construct() {
			add_shortcode( 'vcex_post_type_carousel', array( $this, 'output' ) );

			if ( function_exists( 'vc_lean_map' ) ) {
				TotalThemeCore\WPBakery\Map\Vcex_Post_Type_Carousel::instance();
			}
		...
		public function output( $atts, $content = null ) {
			ob_start();
			do_action( 'vcex_shortcode_before', 'vcex_post_type_carousel', $atts );
			include( vcex_get_shortcode_template( 'vcex_post_type_carousel' ) );
			do_action( 'vcex_shortcode_after', 'vcex_post_type_carousel', $atts );
			return ob_get_clean();
		}
		...
		public static function get_params() {
			...
			return apply_filters( 'vcex_shortcode_params', $params, 'vcex_post_type_carousel' );
		}
