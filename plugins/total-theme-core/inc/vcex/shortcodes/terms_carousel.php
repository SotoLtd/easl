	...
	class VCEX_Terms_Carousel_Shortcode {
		...
		public function __construct() {
			...
			if ( function_exists( 'vc_lean_map' ) ) {
				TotalThemeCore\WPBakery\Map\Vcex_Terms_Carousel::instance();
			}
		...
		public function output( $atts, $content = null ) {
			ob_start();
			do_action( 'vcex_shortcode_before', 'vcex_terms_carousel', $atts );
			include( vcex_get_shortcode_template( 'vcex_terms_carousel' ) );
			do_action( 'vcex_shortcode_after', 'vcex_terms_carousel', $atts );
			return ob_get_clean();
		}
		...
		public static function get_params() {
			...
			return apply_filters( 'vcex_shortcode_params', $params, 'vcex_terms_carousel' );
