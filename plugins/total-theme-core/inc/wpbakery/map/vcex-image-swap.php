...
final class Vcex_Image_Swap {
	...
	public function vc_after_mapping() {
		...
		if ( 'vc_edit_form' === vc_post_param( 'action' ) ) {
			add_filter( 'vc_edit_form_fields_attributes_vcex_image_swap', array( $this, 'edit_fields' ), 10 );
		}
	}
	...
	public function edit_fields( $atts ) {
		$atts = VCEX_Image_Swap_Shortcode::parse_deprecated_attributes( $atts );
		return $atts;
	}
