...
final class Vcex_Heading {
	...
	public function vc_after_mapping() {
		...
		if ( 'vc_edit_form' === vc_post_param( 'action' ) ) {
			add_filter( 'vc_edit_form_fields_attributes_vcex_heading', array( $this, 'edit_fields' ), 10 );
		}
	...
	public function edit_fields( $atts ) {
		...
		$atts = VCEX_Heading_Shortcode::parse_deprecated_attributes( $atts );
		return $atts;
	}
