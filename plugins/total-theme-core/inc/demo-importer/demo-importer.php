...
if ( ! class_exists( 'WPEX_Demo_Importer' ) ) {
	...
	class WPEX_Demo_Importer {
		...
		public function __construct() {
			...
			// Disable Woo Wizard.
			// @todo is it possible to remove this with new versions of WooCommerce?
		...
		public function demos_page() {
			...
			if ( is_string( $this->init_checks ) && 'passed' === $this->init_checks ) {
		...
		public function enqueue_admin_styles( $hook ) {
			...
			wp_enqueue_style(
				...
				WPEX_DEMO_IMPORTER_URI . '/assets/css/wpex-demo-import.css',
				array(),
				TTC_VERSION
			);
		...
		public function enqueue_admin_scripts( $hook ) {
			...
			wp_enqueue_script(
				'total-theme-demo-importer', WPEX_DEMO_IMPORTER_URI . '/assets/js/wpex-demo-import.js',
				array( 'jquery' ),
				TTC_VERSION,
				true
			);
