...
return array(
	'name'           => __( 'EASL MZ Member Directory', 'easl-member-zone' ),
	'base'           => 'easl_mz_member_directory',
	'category'       => __( 'EASL MZ', 'easl-member-zone' ),
	'description'    => __( 'EASL MZ Member Directory', 'easl-member-zone' ),
	'icon'           => 'vcex-icon ticon ticon-users',
	'php_class_name' => 'EASL_VC_MZ_Member_Directory',
	'params'         => array(
		array(
			'type' => 'textfield',
