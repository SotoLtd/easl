...
return array(
	'name'           => __( 'EASL MZ Publications', 'easl-member-zone' ),
	'base'           => 'easl_mz_publications',
	'category'       => __( 'EASL MZ', 'easl-member-zone' ),
	'description'    => __( 'EASL MZ Publications', 'easl-member-zone' ),
	'icon'           => 'vcex-icon ticon ticon-book',
	'php_class_name' => 'EASL_VC_MZ_Publications',
	'params'         => array(
		array(
			'type' => 'textfield',
