...
return array(
	'name'           => __( 'EASL MZ New Member Form', 'easl-member-zone' ),
	'base'           => 'easl_mz_new_member_form',
	'category'       => __( 'EASL MZ', 'easl-member-zone' ),
	'description'    => __( 'Display new member form', 'easl-member-zone' ),
	'icon'           => 'vcex-icon ticon ticon-book',
	'php_class_name' => 'EASL_VC_MZ_New_Member_Form',
	'params'         => array(
		array(
			'type' => 'textfield',
