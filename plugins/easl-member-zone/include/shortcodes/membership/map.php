...
return array(
	'name'           => __( 'EASL MZ Membership', 'easl-member-zone' ),
	'base'           => 'easl_mz_membership',
	'category'       => __( 'EASL MZ', 'easl-member-zone' ),
	'description'    => __( 'EASL MZ Member Profile', 'easl-member-zone' ),
	'icon'           => 'vcex-icon ticon ticon-book',
	'php_class_name' => 'EASL_VC_MZ_Membership',
	'params'         => array(
		array(
			'type' => 'textfield',
		...
		array(
			'type' => 'param_group',
			'heading' => __( 'Sidebar Links', 'easl-member-zone' ),
			'value' => '',
			'param_name' => 'sblinks',
			'params' => array(
				array(
					...
					'value'      => EASL_VC_MZ_Membership::get_icon_widgets_dd(),
					'admin_label' => true,
				),
			),
		),
